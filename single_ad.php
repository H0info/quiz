...
if($_SESSION['type']==1) { $user_info = $_SESSION['nom'].' '.$_SESSION['prenom']; }
else { $user_info = "Guest"; }
           ...
           <div class="col-md-6 col-lg-6">
                <div class="price-box-inner wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                    <div class="price-box" style="text-align: center;">
                        ...
                        <video id="this_video" src="<?php echo $row_q['video']; ?>" autoplay>
            ...
            <div class="col-md-6 col-lg-6">
                <div class="boysge-right wow fadeInUp" style="visibility: visible; animation-name: fadeInUp; height: 450px;">
                    <h3>
                        ...
                        <br />
                        aidez-nous à
                        <span>améliorer</span><br />
                        les annonces
                    </h3>
                    <div id="evaluation">
                    <p>
                        Pouvez vous nous donner votre avis sur <?php echo $row_q['titre']; ?>?
                    </p>
                    <p>
                        <input id="feedback" placeholder="Votre avis ici..." />
                    </p>
...
function evaluation()
{
     ...
     $.ajax({
        url : 'evaluation.php',
        type : 'POST',
        data : ({pub:pub, feedback:feedback, user:user}),
