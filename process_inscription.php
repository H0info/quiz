...
Veuillez noter que le code ci-dessus utilise une variable `$conn` pour représenter votre connexion à la base de données. Assurez-vous d'inclure le fichier `config.php` qui contient les informations de connexion et d'initialisation de la connexion à la base de données.
